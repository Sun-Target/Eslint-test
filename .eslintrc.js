/*
 * @Author: sunrf
 * @Date: 2022-01-03 09:35:50
 * @LastEditors: sunrf
 * @LastEditTime: 2022-01-05 15:22:53
 * @Descripttion: 
 * @FilePath: /study/vue-eslint-demo/.eslintrc.js
 */
// http://eslint.cn/
...
module.exports = {
  ...
  env: {
    ...
    node: true,
    // 自动启用es6语法, 支持新的 ES6 全局变量
    es6: true,
  },
  // 当访问当前源文件内未定义的变量时，no-undef 规则将发出警告，配置全局变量
  globals: {

  },
  //配置文件可以从基础配置中继承已启用的规则, 继承被推荐的规则
  extends: ['plugin:vue/recommended', 'eslint:recommended'],
  // 插件string[]
  plugins: [],
  // 为特定类型的文件指定处理器, array[object]
  overrides: [
